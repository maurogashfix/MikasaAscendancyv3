...
var mensagens = ["Quando você ama, há o risco de odiar.\n\n_Naruto_",
"Não precisa me perdoar...E não importa o que faça daqui pra frente, saiba que.. sempre vou te amar\n\n_Itachi Uchiha_",
"Quando resolve seguir o amor, deve também assumir o risco de conhecer o ódio\n\n_Sasuke_",
...
"Não foi fácil admitir meus sentimentos. Mesmo que eu o tenha decepcionado… não há como eu não amá-lo. Mesmo que eu não seja correspondida.\n\n_Fruits Basket_",
...
"Se a paz realmente existe, eu irei atrás dela sozinho… Mais importante do que obtê-la é… É o poder para acreditar que nós iremos conseguir.\n\n_Nagato_",
"Não existe amor impossível, apenas pessoas incapazes de amar.\n\n_Sakura Haruno_",
"Mas o único que ele não conseguiu matar... foi o irmão. Um homem que chorou lágrimas de sangue, que teve que jogar fora as emoções para matar todos os seus parentes e amigos... Não teve coragem de te matar. Você entende o que isso significa?\n\n_Madara Uchiha_",
...
"Quando alguém te abandona você cria rancor e isso causa mágoas... desfazer laços resulta em mais ódio, corromper laços resulta em mais ódio; o que dói não é crescer, o que dói é ver uma pessoa que tanto amou mudar.\n\n_Naruto_",
"Mesmo ferido se consegue dormir… Mas se causar o ferimento não tem paz, se é exilado, não se consegue dormir.\n\n_Naruto_"
]
...
*/
//Essas Mensagens Já Estão Salvas E Criptografadas Na Index.js!
...
module.exports = { mensagens, sortear }